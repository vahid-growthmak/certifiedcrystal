      ...
      <div className="cc-container py-14 md:py-16">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {ITEMS.map(({ Icon, title, text }) => (
            ...
            >
              <span className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-white text-brand shadow-sm">
                <Icon aria-hidden="true" />
              </span>
              <h3 className="mb-2 text-[17px] font-medium text-heading">
                {title}
              </h3>
